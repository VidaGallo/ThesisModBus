...
def create_decision_variables_LR(mdl: Model, I: Instance):
    """
...
def add_taxi_like_constraints_LR(mdl, I, x, y, r, L, R, s):
    """
...
def add_taxi_like_objective_LR(mdl, I, y, s):
    """
...
def create_taxi_like_model_LR(I: Instance):
    """
    Create:
        - Model()
        - decision variables
    ...
    # 1) variables
    x, y, r, L, R, s = create_decision_variables_LR(mdl, I)

    # 2) constraints
    add_taxi_like_constraints_LR(mdl, I, x, y, r, L, R, s)

    # 3) objective
    add_taxi_like_objective_LR(mdl, I, y, s)
